...
type Service interface {
  handler.Methods
  Start(dynamoDB dynamodb.Service, monzo monzoapi.Service, monzoClient _monzoapi.MonzoClient)
}

type service struct {
  dynamoDB dynamodb.Service
  monzo monzoapi.Service
  monzoClient _monzoapi.MonzoClient
}
...
func (s *service) Start(dynamoDB dynamodb.Service, monzo monzoapi.Service, monzoClient _monzoapi.MonzoClient) {
